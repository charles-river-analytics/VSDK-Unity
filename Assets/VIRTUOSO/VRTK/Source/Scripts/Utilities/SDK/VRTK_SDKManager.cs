...
namespace VRTK
{
    ...
    public sealed class VRTK_SDKManager : MonoBehaviour
    {
        ...
        public static readonly Dictionary<Type, Type> SDKFallbackTypesByBaseType = new Dictionary<Type, Type>
        {
            ...
            { typeof(SDK_BaseTracker), typeof(SDK_FallbackTracker) },
            { typeof(SDK_BaseHand), typeof(SDK_FallbackHand) }
        };
        ...
        /// <summary>
        /// All available tracker SDK infos.
        /// </summary>
        public static ReadOnlyCollection<VRTK_SDKInfo> AvailableTrackerSDKInfos { get; private set; }
        /// <summary>
        /// All available hand SDK infos.
        /// </summary>
        public static ReadOnlyCollection<VRTK_SDKInfo> AvailableHandSDKInfos { get; private set; }
        ...
        /// <summary>
        /// All installed tracker SDK infos. This is a subset of <see cref="AvailableTrackerSDKInfos"/>.
        /// It contains only those available SDK infos for which an <see cref="SDK_ScriptingDefineSymbolPredicateAttribute"/> exists
        /// that uses the same symbol and whose associated method returns true.
        /// </summary>
        public static ReadOnlyCollection<VRTK_SDKInfo> InstalledTrackerSDKInfos { get; private set; }
        /// <summary>
        /// All installed hand SDK infos. This is a subset of <see cref="AvailableHandSDKInfos"/>.
        /// It contains only those available SDK infos for which an <see cref="SDK_ScriptingDefineSymbolPredicateAttribute"/> exists
        /// that uses the same symbol and whose associated method returns true.
        /// </summary>
        public static ReadOnlyCollection<VRTK_SDKInfo> InstalledHandSDKInfos { get; private set; }
        ...
        public bool ManageScriptingDefineSymbols(bool ignoreAutoManageScriptDefines, bool ignoreIsActiveAndEnabled)
        {
            ...
            VRTK_SDKInfo[] availableSDKInfos = AvailableSystemSDKInfos
                ...
                .Concat(AvailableTrackerSDKInfos)
                .Concat(AvailableHandSDKInfos)
                .ToArray();
        ...
        public void ManageVRSettings(bool force)
        {
            ...
            Dictionary<BuildTargetGroup, string[]> deviceNamesByTargetGroup = setups
                ...
                {
                    setup.systemSDKInfo, setup.boundariesSDKInfo, setup.headsetSDKInfo, setup.controllerSDKInfo, setup.handSDKInfo
                })
            ...
            if (previousLoadedSetup != null)
            {
                _previouslyUsedSetupInfos.UnionWith(
                    new[]
                    {
                        ...
                        previousLoadedSetup.trackerSDKInfo,
                        previousLoadedSetup.handSDKInfo
                    }
                );
            }
        }
...
#pragma warning restore 618
        ...
        private static void PopulateAvailableAndInstalledSDKInfos()
        {
            ...
            List<VRTK_SDKInfo> availableTrackerSDKInfos = new List<VRTK_SDKInfo>();
            List<VRTK_SDKInfo> availableHandSDKInfos = new List<VRTK_SDKInfo>();
            ...
            List<VRTK_SDKInfo> installedTrackerSDKInfos = new List<VRTK_SDKInfo>();
            List<VRTK_SDKInfo> installedHandSDKInfos = new List<VRTK_SDKInfo>();
            ...
            PopulateAvailableAndInstalledSDKInfos<SDK_BaseTracker, SDK_FallbackTracker>(availableTrackerSDKInfos, installedTrackerSDKInfos, symbolsOfInstalledSDKs);
            PopulateAvailableAndInstalledSDKInfos<SDK_BaseHand, SDK_FallbackHand>(availableHandSDKInfos, installedHandSDKInfos, symbolsOfInstalledSDKs);
            ...
            AvailableTrackerSDKInfos = availableTrackerSDKInfos.AsReadOnly();
            AvailableHandSDKInfos = availableHandSDKInfos.AsReadOnly();
            ...
            InstalledTrackerSDKInfos = installedTrackerSDKInfos.AsReadOnly();
            InstalledHandSDKInfos = installedHandSDKInfos.AsReadOnly();
        }
