...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        public enum ValidDropTypes
        {
            ...
            DropAnywhere,
            /// <summary>
            /// The object can only be dropped when it is hovering over a valid interaction area.
            /// </summary>
        ...
        public bool HasExtraEventArgs
        {
            get
            {
                var hasEventSender = GetComponent<CharlesRiverAnalytics.Virtuoso.EventArgSender>();

                if(hasEventSender == null)
                {
                    return false;
                }
                else
        ...
        /// <summary>
        /// Emitted when the object reaches a finish state with an object (e.g. syringe is empty)
        /// </summary>
        public event InteractableObjectEventHandler InteractableObjectUseFinish;
        /// <summary>
        ...
        public virtual void OnInteractableObjectUseFinish(InteractableObjectEventArgs e)
        {
            if (InteractableObjectUseFinish != null)
            {
                InteractableObjectUseFinish(this, e);
            }
        }
        ...
        {
            // Blank virtual method that allows subclass to give their own implementation (or not)
        }

        public virtual void InteractionAreaFinished(object o, InteractionAreaEventArgs e)
        {
            // Blank virtual method that allows subclass to give their own implementation (or not)
        }

        public virtual void InteractionAreaInterrupted(object o, InteractionAreaEventArgs e)
        {
            // Blank virtual method that allows subclass to give their own implementation (or not)
        }
        #endregion
