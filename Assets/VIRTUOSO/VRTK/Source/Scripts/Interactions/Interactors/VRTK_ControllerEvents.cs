...
namespace VRTK
{
    ...
    public class ControllerInteractionEventArgs : EventArgs
    {
    ...
    public class VRTK_ControllerEvents : MonoBehaviour
    {
        ...
        public virtual ControllerInteractionEventArgs SetControllerEvent(ref bool buttonBool, bool value = false, float buttonPressure = 0f)
        {
            ...
            ControllerInteractionEventArgs e = new ControllerInteractionEventArgs
            {
                ...
                touchpadAxis = VRTK_SDK_Bridge.GetControllerAxis(SDK_BaseController.ButtonTypes.Touchpad, controllerReference)
            };
