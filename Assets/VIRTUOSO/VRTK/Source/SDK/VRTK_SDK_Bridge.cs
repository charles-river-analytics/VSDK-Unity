namespace VRTK
{
    ...
    public static class VRTK_SDK_Bridge
    {
        ...
        private static SDK_BaseTracker trackerSDK = null;
        private static SDK_BaseHand handSDK = null;
        ...
        public static void TrackerProcessUpdate(VRTK_ControllerReference controllerReference, Dictionary<string, object> options = null)
        {
            GetTrackerSDK().ProcessUpdate(controllerReference, options);
        }

        public static void TrackerProcessFixedUpdate(VRTK_ControllerReference controllerReference, Dictionary<string, object> options = null)
        {
            GetTrackerSDK().ProcessFixedUpdate(controllerReference, options);
        }

        public static uint GetTrackerIndex(GameObject tracker)
        {
            return GetTrackerSDK().GetTrackerIndex(tracker);
        }
        #endregion
        ...
        public static SDK_BaseHand GetHandSDK()
        {
            if (VRTK_SDKManager.instance != null && VRTK_SDKManager.instance.loadedSetup != null)
            {
                return VRTK_SDKManager.instance.loadedSetup.handSDK;
            }
            if (handSDK == null)
            {
                handSDK = ScriptableObject.CreateInstance<SDK_FallbackHand>();
            }
            return handSDK;
        }
